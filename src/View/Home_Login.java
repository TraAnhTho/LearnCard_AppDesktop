...
public class Home_Login extends JFrame {
    ...
    private JTable updatedTable;
    private JTable table1;
    private JTable valueUpdatedTable;
    ...
    private DefaultTableModel dtmUpdatedValue;
    ...
    public Home_Login(String iduser) throws Exception {
        ...
        panel_Edit_List.add(new JScrollPane(updatedTable = new JTable(dtm)));
        updatedTable.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(118, 203, 33)));
        updatedTable.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 13));
        updatedTable.setBackground(new Color(255, 255, 255));
        updatedTable.setForeground(new Color(118, 203, 33));
        updatedTable.setRowHeight(30);
        updatedTable.getTableHeader().setFont(new Font("Tahoma", Font.PLAIN, 15));
        ...
        dtmUpdatedValue = new DefaultTableModel(header3, 0) {

        };
        panel_Edit_Card.add(new JScrollPane(valueUpdatedTable = new JTable(dtmUpdatedValue)));
        valueUpdatedTable.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(118, 203, 33)));
        valueUpdatedTable.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 13));
        valueUpdatedTable.setBackground(new Color(255, 255, 255));
        valueUpdatedTable.setForeground(new Color(118, 203, 33));
        valueUpdatedTable.setRowHeight(30);
        valueUpdatedTable.getTableHeader().setFont(new Font("Tahoma", Font.PLAIN, 15));
        JScrollPane scrollPane2 = new JScrollPane(valueUpdatedTable);
...
//		       LoadDBData3JTable(txt_list_card.getText());
        ...
        btn_select_edit.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    DefaultTableModel model_table = (DefaultTableModel) updatedTable.getModel();
                    int i_row = updatedTable.getSelectedRow();
